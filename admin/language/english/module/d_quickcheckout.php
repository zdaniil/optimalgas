...
// Heading
    ...
    $_['text_intro_create_setting'] = '<h4>Create new Setting</h4>You have just installed the new version of Custom Quick Checkout. To start you will need to create your first checkout setting. CLick create setting, edit and then save. Your new checkout will appear on the frontend.';

    $_['text_home'] = 'Home';
    $_['text_intro_home'] = 'Customize your One-step checkout to increase your sales';

    $_['text_intro_general'] = 'Set up the general settings of your Custom Quick Checkout (CQC). You can also define positions as a module.';
...
//social login
    $_['text_social_login_required'] = '<h4>Social Login Required</h4><p>To use social login option in CQC, you need to install the Social Login module from Dreamvention, and setup the Social Apps. To learn how to do it follow the instructions from the Social login module.</p><p>By activating the social login buttons here, you are displaying them in the Custom Quick Checkout in the step Login</p>';
