...
//group
$_['text_group_shipping_mode']    = 'Group mode of the method groups (First Level Grouping)';
...
$_['text_group_limit']    = 'Limit of methods showing';
$_['text_group_name']    = 'Group Name';
$_['text_method_group']    = 'Method Groups (Second Level Grouping)';
$_['tip_method_group']    = 'You can divide your shipping methods up to 10 groups and can be applied different operation to each group. In case of highest/lowest operation, you can set a limit of method numbers that you want to show. Here are available group type/operation <br /><b>Lowest</b>: Only shipping method with lowest cost will be shown .<br /><b>Highest</b>: Only Shipping method with highest cost will be shown.<br /><b>Average</b>: All shipping costs will be averaged.<br /><b>Sum</b>: All shipping costs will be summed.<br /><b>AND</b>: All Shipping Methods of the group will be considered as AND operation. Only first shipping method of the group will be shown only if all the shipping methods of the group validate all rules.';
...
/* tooltip */
$_['tip_group_name']       = 'Group name will overwrite method\'s original name. You can also insert orignal method name and price by placing #1, @1 etc. For example, #1 means first method name, @1 first method price';
$_['tip_group_limit']       = 'You can limit number of highest/lowest methods here. By default it will show only one method';
...
$_['tip_grouping']       = 'This is the top tier of the grouping. This means it is the group of the groups. If method groups are available, this grouping will work with the results of the method groups, otherwise this grouping will work with main shipping methods. Shipping methods having same <i>Sort Order</i> value will be considered as a group. <i>Sort Order</i> can be found under general tab of the each shipping method.  <br /> <br> <b>No Grouping</b>: Grouping will be disregarded. No group will be considered.<br /><b>Lowest</b>: Only shipping method with lowest cost will be considered .<br /><b>Highest</b>: Only shipping method with highest cost will be considered.<br /><b>Average</b>: All shipping costs will be averaged.<br /><b>Sum</b>: All shipping costs will be summed.';
