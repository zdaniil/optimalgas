		...
		<div class="panel panel-default">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<div class="form-group clearfix">
					...
					<div class="col-sm-10">
						<input type="text" name="novaposhta_api_key" value="<?php echo $novaposhta_api_key; ?>" class="form-control"/>
					</div>
				</div>
				<div class="form-group clearfix">
					<label class="col-sm-2 control-label" for="input-field">
						<?php echo $entry_sender_organization; ?>
					</label>
					<div class="col-sm-10">
						<input type="text" name="novaposhta_sender_organization"
                                   value="<?php echo $novaposhta_sender_organization; ?>" class="form-control"/>
					</div>
				</div>
				<div class="form-group clearfix">
					<label class="col-sm-2 control-label" for="input-field">
						<?php echo $entry_sender_person; ?>
					</label>
					<div class="col-sm-10">
						<input type="text" name="novaposhta_sender_person"
                                   value="<?php echo $novaposhta_sender_person; ?>" class="form-control"/>
					</div>
				</div>
				<div class="form-group clearfix">
					<label class="col-sm-2 control-label" for="input-field">
					...
					<div class="col-sm-10">
						<input type="text" name="novaposhta_sender_phone"
                                   value="<?php echo $novaposhta_sender_phone; ?>" class="form-control"/>
					</div>
				</div>
				<div class="form-group clearfix">
					<label class="col-sm-2 control-label" for="input-field">
				...
				<div class="form-group clearfix">
					...
					<div class="col-sm-10">
						<select name="novaposhta_geo_zone_id" class="form-control">
				...
				<div class="form-group clearfix">
					<label class="col-sm-2 control-label" for="input-field">
						<?php echo $entry_send_order_status; ?>
					</label>
					<div class="col-sm-10">
						<select name="novaposhta_send_order_status" class="form-control">
				...
				<div class="form-group clearfix">
					...
					<div class="col-sm-10">
						<select name="novaposhta_status" class="form-control">
				...
				<div class="form-group clearfix">
					...
					<div class="col-sm-10">
						<input type="text" name="novaposhta_sort_order"
                                   value="<?php echo $novaposhta_sort_order; ?>" size="1" class="form-control"/>
					</div>
				</div>
            </form>
			</div>
