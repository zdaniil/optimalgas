(function($) {
    ...
    // выводим форму логина   
     $("<div id='temp_flat_container'><img src='" + self.params.additionalPath + self.resources.loading + "'></div>").insertAfter('#showlogin');

// $('#constant').parent().before("<div id='temp_flat_container'><img src='" + self.params.additionalPath + self.resources.loading + "'></div>");
