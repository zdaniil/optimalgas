<div class="<?php if ($type <> 'radio') { ?>input-row<?php } ?> <?php if ($required) { ?>required<?php } ?>">
    ...
    <div>
      ...
      <div class="radio-group">
        <?php foreach ($values as $key => $info) { ?>
            <div class="radio-row">
          <input type="radio" name="<?php echo $name ?>" id="<?php echo $id.$key ?>" value="<?php echo $info['id'] ?>" <?php echo $value == $info['id'] ? 'checked="checked"' : '' ?> <?php echo $reload ? 'data-onchange="reloadAll"' : 'data-reload-payment-form="true"'?>>
            <label for="<?php echo $id.$key ?>"><?php echo $info['text'] ?></label>
             </div>
        <?php } ?>
        </div>
      ...
      <?php } else { ?>
        <input type="<?php echo $type ?>" name="<?php echo $name ?>" id="<?php echo $id ?>" value="<?php echo $value ?>" placeholder="<?php echo $placeholder ?>" <?php echo $attrs ?> <?php echo $reload ? 'data-onchange="reloadAll"' : 'data-reload-payment-form="true"'?>>
      <?php } ?>
      <?php if (!empty($rules)) { ?>
