...
$data['text_newsblog'] = $this->language->get('text_newsblog');$data['text_newsblog_category'] = $this->language->get('text_newsblog_category');$data['text_newsblog_article'] = $this->language->get('text_newsblog_article');
...
$data['newsblog_category'] = $this->url->link('newsblog/category', 'token=' . $this->session->data['token'], 'SSL');$data['newsblog_article'] = $this->url->link('newsblog/article', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['order_recurring'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['token'], 'SSL');
			...
			$data['productmanager'] = 'Менеджер товаров';
