...
<li><a href="<?php echo $productmanager_link; ?>"><?php echo $productmanager; ?></a></li>
  ...
  <li id="sale"><a class="" href="<?php echo $order; ?>"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_order; ?></span></a>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_marketing; ?></a>
        <ul>
          ...
          <li style="display:none;"><a href="<?php echo $report_affiliate; ?>"><?php echo $text_report_affiliate; ?></a></li>
          <li style="display:none;"><a href="<?php echo $report_affiliate_activity; ?>"><?php echo $text_report_affiliate_activity; ?></a></li>
        </ul>
      </li>
    </ul>
  </li>
